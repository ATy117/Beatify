...
import view.View;
import view_builders.Artist.builderSong_ArtistPlaylistOwnedSongs;
import view_builders.Director;
import view_builders.Listener.builderSong_ListenerPlaylistOwnedSongs;
...
public class viewSong_ListenerPlaylistOwnedSongs extends View {
    ...
    @FXML
    AnchorPane songsHeader;
    @FXML
    JFXListView songListView;
    ...
    private void setSongs () {
        ...
        builderSong builder = new builderSong_ListenerPlaylistOwnedSongs(controller);
