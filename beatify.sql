...
CREATE TABLE `album` (
  ...
  `album_cover` mediumblob NOT NULL,
...
CREATE TABLE `album_contents` (
  ...
  CONSTRAINT `albumIDMapping` FOREIGN KEY (`album_id`) REFERENCES `album` (`album_id`) ON DELETE RESTRICT,
...
CREATE TABLE `followed_playlist` (
  ...
  CONSTRAINT `followerIDPlaylist` FOREIGN KEY (`follower_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE RESTRICT,
...
CREATE TABLE `playlist_contents` (
  ...
  CONSTRAINT `playlistIDMapping` FOREIGN KEY (`playlist_id`) REFERENCES `playlist` (`playlist_id`) ON DELETE CASCADE ON UPDATE RESTRICT,
...
CREATE TABLE `song` (
  ...
  CONSTRAINT `artistIdSong` FOREIGN KEY (`artist_id`) REFERENCES `user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
